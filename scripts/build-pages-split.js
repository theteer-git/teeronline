...
const required = ['index.html', 'common-numbers.html'];
...
// Pages serves extensionless HTML automatically. These headers prevent a
// browser from holding an old deployment while Cloudflare's static edge
...
// Keep canonical public URLs clean if somebody explicitly requests .html.
fs.writeFileSync(
...
console.log('Included: index.html, common-numbers.html, _headers, _redirects');
