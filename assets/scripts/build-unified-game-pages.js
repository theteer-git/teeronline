...
for (const gameId of config.gameOrder) {
  ...
  $('link[href*="game-unified-page.css"]').attr("href", "/assets/css/game-unified-page.css?v=20260822-ux-v5");
  if (!$('link[href*="theme-ux.css"]').length) {
    $("head").append('<link href="/assets/css/theme-ux.css?v=20260822-ux-v5" rel="stylesheet"/>');
  }
  ...
  $("body").append('<script src="/assets/scripts/game-config.js" defer></script><script src="/assets/scripts/game-unified-page.js" defer></script><script src="/assets/scripts/teer-shell.js?v=20260822-ux-v5" defer></script>');
