(() => {
            ...
            function extractData(raw) {
               ...
               // FIXED: Corrected aliases - removed "shillong day" from JWM
               const aliases = {
               ...
               const targetGame = (
                  typeof GAME_NAME !== "undefined" ? GAME_NAME : "juwai morning"
               )
                  .toLowerCase()
                  .trim();
            ...
            async function loadData() {
               try {
                  ...
                  if (!originalData.length)
                     throw new Error(
                        'No valid "juwai morning" records found. Please check your data file.',
                     );
                  currentData = originalData.slice();
                  ...
                  errorDiv.innerHTML = `<strong>❌ Failed to load https://static-results.teeronline.com/all-results.json</strong><br><br>${err.message}<br><br>Check that the file exists and contains records with <code>"game": "juwai morning"</code>.`;
