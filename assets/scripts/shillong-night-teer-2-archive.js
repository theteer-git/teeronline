(() => {
            ...
            function extractData(raw) {
               ...
               // FIXED: Corrected aliases - removed "shillong day" from SHN2
               const aliases = {
            ...
            function applyFilters() {
               if (!numberSearch || !dateCalendar || !daySearch || !roundSearch)
                  return;
            ...
            function resetFilters() {
               ...
               if (daySearch) daySearch.value = "";
               if (roundSearch) roundSearch.value = "";
            ...
            async function loadData() {
               try {
                  ...
                  if (tbody && !tbody.querySelector('tr[data-static-archive-row="true"]'))
                     tbody.innerHTML =
